...
cp Motorsport.sh /home/$USER/Launchers
...
sleep 1s
echo "Here from the Formula Student domain? go to https://github.com/AMZ-Driverless/ and download FSSIM and any tools that you need for development."
sleep 1s
echo " "
